...
# MAGIC <img width="1px" src="https://ppxrzfxige.execute-api.us-west-2.amazonaws.com/v1/analytics?category=lakehouse&org_id=4399380626557544&notebook=%2F01-Data-ingestion%2F01.3-DLT-churn-python&demo_name=lakehouse-retail-c360&event=VIEW&path=%2F_dbdemos%2Flakehouse%2Flakehouse-retail-c360%2F01-Data-ingestion%2F01.3-DLT-churn-python&version=1">
...
# MAGIC %md
# MAGIC Your DLT Pipeline has been installed and started for you! Open the <a dbdemos-pipeline-id="dlt-churn" href="#joblist/pipelines/c416affd-6d09-4c28-b576-d0250ce0d822" target="_blank">Churn Delta Live Table pipeline</a> to see it in action.<br/>
...
# MAGIC
# MAGIC Open the <a dbdemos-pipeline-id="dlt-churn" href="#joblist/pipelines/c416affd-6d09-4c28-b576-d0250ce0d822" target="_blank">Churn Delta Live Table pipeline</a> and click on start to visualize your lineage and consume the new data incrementally!
...
# MAGIC
# MAGIC <a dbdemos-dashboard-id="dlt-quality-stat" href='/sql/dashboardsv3/01ef5ad276cf19268b5114dafb2b2e88' target="_blank">Data Quality Dashboard</a>
...
# MAGIC
# MAGIC <a dbdemos-dashboard-id="churn-universal" href='/sql/dashboardsv3/01ef5ad276cf19268b5114dafb2b2e88'  target="_blank">Open the DBSQL Dashboard</a>
